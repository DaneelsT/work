<main>
    <div class="panel panelSeperatorBottom">
        <div class="panelContent">
            <h2><?php echo translate("Monthly Overview"); ?> - <?php echo $currentMonth; ?> <a href="<?php echo placeHttpRoot(); ?>year/close" id="closeyear" class="button right"><?php echo translate("Close Year"); ?></h2>
